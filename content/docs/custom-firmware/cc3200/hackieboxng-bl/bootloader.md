...
| patches | List of patches to load, see [patch directory](https://github.com/toniebox-reverse-engineering/hackiebox_cfw_ng/tree/master/sd-bootloader-ng/bootmanager/sd/revvox/boot/patch) or [patch wiki](../ofw-patches)  | ["noCerts.305", "noPass3.305"] | [] |
...
[More about available ofw patches](../ofw-patches)
